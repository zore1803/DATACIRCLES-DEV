...
const FieldMappingModal = ({
  ...
  // Normalize companyFieldNames - memoize to prevent infinite loops
  const normalizedCompanyFields = useMemo(() => {
    if (!Array.isArray(companyFieldNames)) return [];
    
    return companyFieldNames.map(field => {
  ...
  const handleImport = useCallback(() => {
    ...
    handleClose();
  }, [fieldMapping, includeFirstRow, selectedTemplate, onImport]);
          ...
          <div className="mb-6">
            ...
            {/* <div className="mb-6">
              ...
              <select
                ...
                className="w-full max-w-xs border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 shadow-sm"
              >
