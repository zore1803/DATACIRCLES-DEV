...
// Same pattern as CompanyFieldSettings' SortableFieldRow/DroppableSection - a draggable <tr> with
// its own grip-handle column, and a section wrapper that stays droppable even when it has no rows.
...
// The five fields every contact form ships with - live on the Contact model itself, not the
// custom-fields collection, so they're hardcoded the same way CompanyFieldSettings' BUILT_IN_FIELDS is.
const BUILT_IN_FIELDS = [
  { name: "Name", type: "String (Single-line)", required: true },
...
const ContactFieldSettings = () => {
  ...
  // empty sections, which have no row to aim at). Same logic as CompanyFieldSettings.
  ...
  // Reorder within the flat custom-field list. Persisted straight away, same as KanbanSettings.
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        ...
        >
          <input
            ...
            placeholder="Add custom field (e.g. LinkedIn Profile)"
        ...
        >
          <input
            ...
            placeholder="Add section (e.g. Social Profiles)"
        ...
        <p className="text-xs text-gray-400 mt-3">
          These ship with every contact form and cannot be edited or removed. Add your own under
          the Custom tab.
        </p>
        </>
        )}
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-700 space-y-1 leading-relaxed flex justify-between md:justify-start md:space-x-6 md:space-y-0">
              <div>
                <li>• <strong>Text:</strong> Multi-line text area for long descriptions</li>
                <li>• <strong>String:</strong> Single-line input for short text</li>
              </div>
              <div>
