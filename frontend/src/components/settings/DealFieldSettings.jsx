...
// The five fields every deal form ships with - live on the Deal model itself, not the
// custom-fields collection, so they're hardcoded the same way CompanyFieldSettings' BUILT_IN_FIELDS is.
const BUILT_IN_FIELDS = [
  { name: "Title", type: "String (Single-line)", required: true },
  { name: "Amount", type: "Number (Currency)", required: true },
  { name: "Status", type: "Dropdown (Kanban Statuses)", required: true },
  { name: "Company", type: "Dropdown (Company List)", required: true },
  { name: "Contact", type: "Dropdown (Contact List)", required: true },
];
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        ...
        >
          <input
            ...
            placeholder="Add custom field (e.g. Expected Close Date)"
        ...
        <p className="text-xs text-gray-400 mt-3">
          These ship with every deal form and cannot be edited or removed. Add your own under
          the Custom tab.
        </p>
        </>
        )}
