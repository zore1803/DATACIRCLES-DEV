...
// The nine fields every item form ships with - live on the Item model itself, not the
// custom-fields collection, so they're hardcoded the same way CompanyFieldSettings' BUILT_IN_FIELDS is.
const BUILT_IN_FIELDS = [
  { name: "Item Name", type: "String (Single-line)", required: true },
  { name: "Item Type", type: "Dropdown (Product / Service)", required: true },
  { name: "Description", type: "Text (Multi-line)", required: false },
  { name: "Purchase Price", type: "Number", required: true },
  { name: "Selling Price", type: "Number", required: true },
  { name: "GST Rate", type: "Number", required: false },
  { name: "HSN / SAC", type: "String (Single-line)", required: false },
  { name: "Barcode", type: "String (Single-line)", required: false },
  { name: "Category", type: "String (Single-line)", required: false },
  { name: "Primary Unit", type: "Dropdown", required: false },
];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        ...
        <p className="text-xs text-gray-400 mt-3">
          These ship with every item form and cannot be edited or removed. Add your own under
          the Custom tab.
        </p>
        </>
        )}
